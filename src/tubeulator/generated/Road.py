...
LoadMeta(raise_on_unknown_json_key=True).bind_to(Get200_or_idsGet200_or_idsStatusGet200ApplicationJsonResponseDeserialiser)
...
LoadMeta(raise_on_unknown_json_key=True).bind_to(idsDisruptionGet200ApplicationJsonResponseDeserialiser)
...
LoadMeta(raise_on_unknown_json_key=True).bind_to(MetaSeveritiesGet200ApplicationJsonResponseDeserialiser)
