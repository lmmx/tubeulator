...
class DbGeographyDeserialiser(JSONWizard):
    ...
    Geography: dict = None
    __source_schema_name: str = 'Road'
    __component_schema_name: str = 'System-2'
...
class ObjectDeserialiser(JSONWizard):
    ...
    """
    __source_schema_name: str = 'Road'
    __component_schema_name: str = 'System-3'
...
class MetaSeveritiesGet200ApplicationJsonResponseDeserialiser(JSONWizard):
    ...
    """
    __source_schema_name: str = 'Road'
    __component_schema_name: str = 'MetaSeveritiesGet200ApplicationJsonResponse'
