...
@dataclass
class MetaCategoriesGet200_or_MetaPlaceTypesGet200ApplicationJsonResponseDeserialiser(
    JSONWizard
):
    """
...
LoadMeta(raise_on_unknown_json_key=True).bind_to(
    MetaCategoriesGet200_or_MetaPlaceTypesGet200ApplicationJsonResponseDeserialiser
)
...
@dataclass
class TypetypesGet200_or_idGet200_or_SearchGet200ApplicationJsonResponseDeserialiser(
    JSONWizard
):
    """
...
LoadMeta(raise_on_unknown_json_key=True).bind_to(
    TypetypesGet200_or_idGet200_or_SearchGet200ApplicationJsonResponseDeserialiser
)
