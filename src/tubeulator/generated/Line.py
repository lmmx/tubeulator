...
LoadMeta(raise_on_unknown_json_key=True).bind_to(
    MetaSeverityGet200ApplicationJsonResponseDeserialiser
)
...
@dataclass
class idsGet200_or_ModemodesGet200_or_RouteGet200_or_idsRouteGet200_or_ModemodesRouteGet200_or_idsStatusstartDateToendDateGet200_or_idsStatusGet200_or_StatusseverityGet200_or_ModemodesStatusGet200ApplicationJsonResponseDeserialiser(
    JSONWizard
):
    """
...
LoadMeta(raise_on_unknown_json_key=True).bind_to(
    idsGet200_or_ModemodesGet200_or_RouteGet200_or_idsRouteGet200_or_ModemodesRouteGet200_or_idsStatusstartDateToendDateGet200_or_idsStatusGet200_or_StatusseverityGet200_or_ModemodesStatusGet200ApplicationJsonResponseDeserialiser
)
...
LoadMeta(raise_on_unknown_json_key=True).bind_to(
    idStopPointsGet200ApplicationJsonResponseDeserialiser
)


@dataclass
class idsDisruptionGet200_or_ModemodesDisruptionGet200ApplicationJsonResponseDeserialiser(
    JSONWizard
):
    """
...
LoadMeta(raise_on_unknown_json_key=True).bind_to(
    idsDisruptionGet200_or_ModemodesDisruptionGet200ApplicationJsonResponseDeserialiser
)
...
@dataclass
class idsArrivalsstopPointIdGet200_or_idsArrivalsGet200ApplicationJsonResponseDeserialiser(
    JSONWizard
):
    """
...
LoadMeta(raise_on_unknown_json_key=True).bind_to(
    idsArrivalsstopPointIdGet200_or_idsArrivalsGet200ApplicationJsonResponseDeserialiser
)
