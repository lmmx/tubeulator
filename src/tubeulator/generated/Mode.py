...
class ActiveServiceTypeArrayDeserialiser(JSONWizard):
    ...
    """
    __source_schema_name: str = 'Mode'
    __component_schema_name: str = 'Tfl-Api-Presentation-Entities-ActiveServiceTypeArray'
...
class ActiveServiceTypeDeserialiser(JSONWizard):
    ...
    __source_schema_name: str = 'Mode'
    __component_schema_name: str = 'Tfl.Api.Presentation.Entities.ActiveServiceType'
...
class PredictionArrayDeserialiser(JSONWizard):
    ...
    """
    __source_schema_name: str = 'Mode'
    __component_schema_name: str = 'Tfl-Api-Presentation-Entities-PredictionArray-4'
...
class PredictionDeserialiser(JSONWizard):
    ...
    Timing: dict = None
    __source_schema_name: str = 'Mode'
    __component_schema_name: str = 'Tfl.Api.Presentation.Entities.Prediction'
...
class PredictionTimingDeserialiser(JSONWizard):
    ...
    Received: str = None
    __source_schema_name: str = 'Mode'
    __component_schema_name: str = 'Tfl.Api.Presentation.Entities.PredictionTiming'
