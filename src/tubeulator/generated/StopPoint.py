...
@dataclass
class idPlaceTypesGet200ApplicationJsonResponseDeserialiser(JSONWizard):
    """
...
@dataclass
class idCrowdinglineGet200ApplicationJsonResponseDeserialiser(JSONWizard):
    """
...
@dataclass
class TypetypesPagepageGet200ApplicationJsonResponseDeserialiser(JSONWizard):
    """
...
@dataclass
class idCanReachOnLinelineIdGet200ApplicationJsonResponseDeserialiser(JSONWizard):
    """
...
@dataclass
class stopPointIdTaxiRanksGet200ApplicationJsonResponseDeserialiser(JSONWizard):
    """
...
@dataclass
class stopPointIdCarParksGet200ApplicationJsonResponseDeserialiser(JSONWizard):
    """
